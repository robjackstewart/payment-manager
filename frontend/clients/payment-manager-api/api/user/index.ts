...
// @ts-ignore
import { createResponseFromDiscriminatorValue, serializeCreateUser, serializeResponse, type CreateUser, type Response } from '../../models/index.js';
// @ts-ignore
...
export interface UserRequestBuilder extends BaseRequestBuilder<UserRequestBuilder> {
     ...
     */
     post(body: CreateUser, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<Response | undefined>;
    /**
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
