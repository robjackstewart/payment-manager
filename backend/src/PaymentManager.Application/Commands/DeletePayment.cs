...
{
    internal sealed class Handler(IPaymentManagerContext context, ILogger<Handler> logger) : IRequestHandler<DeletePayment>
    {
        public async Task Handle(DeletePayment request, CancellationToken cancellationToken)
        {
